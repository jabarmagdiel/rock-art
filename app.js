...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // =========================================================================
  // 9. Música Ambiental de Relajación
  // =========================================================================
  ...
  if (ambientAudio) {
    ...
    const updateAudioUI = (isPlaying) => {
      ...
      if (soundIcon) {
        soundIcon.className = isPlaying ? 'fa-solid fa-volume-high' : 'fa-solid fa-volume-xmark';
      }
    };

    ambientAudio.addEventListener('play', () => updateAudioUI(true));
    ambientAudio.addEventListener('pause', () => updateAudioUI(false));
    ambientAudio.addEventListener('ended', () => updateAudioUI(false));
